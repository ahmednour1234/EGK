...
return [
    ...
    'title' => \App\Helpers\ScribeHelper::getDescription(),

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => \App\Helpers\ScribeHelper::getDescription(),
    ...
    'base_url' => \App\Helpers\ScribeHelper::getBaseUrl(),
    ...
    'routes' => [
        [
            ...
            'exclude' => [
                // 'GET /health', 'admin.*'
                'POST api/sender/upload-avatar', // Exclude file upload route from Scribe processing
            ],
        ],
    ],
